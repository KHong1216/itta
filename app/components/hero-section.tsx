  ...
  return (
    <section className="relative pt-24 pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        {/* Badge */}
        <div className="inline-flex items-center rounded-full px-4 py-1.5 text-sm font-semibold bg-indigo-50 text-indigo-700 mb-8 border border-indigo-100">
          {badgeText}
        </div>
        ...
        <h1 className="text-5xl md:text-8xl font-black tracking-tight mb-8 text-slate-900">
          {heading}
          <br />
          사람과 <span className="text-indigo-600">{headingAccent}</span>
        </h1>
        ...
        <p className="text-lg md:text-2xl text-slate-500 max-w-3xl mx-auto mb-12 leading-relaxed">
          ...
          <br />
          복잡한 관계의 부담은 덜어내고,{" "}
          <span className="text-slate-900 font-bold underline underline-offset-4 decoration-indigo-300">
